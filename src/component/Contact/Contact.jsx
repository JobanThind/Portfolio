        ...
        <>
            <section id='contact' className="space-x-4 px-4 py-8 bg-white dark:bg-gray-800">
                <h1 className="text-center mb-4 text-3xl font-extrabold leading-none tracking-tight text-gray-900 md:text-4xl md:text-5xl dark:text-white">
                    GET <mark className="px-2 text-white bg-indigo-600 rounded dark:bg-indigo-500">IN</mark> TOUCH
                </h1>
                    ...
                    <div className="w-full flex flex-col  lg:flex-row justify-around items-center p-6 ">
                        ...
                        <div className="flex flex-row lg:flex-col lg:block hidden">
                            ...
                            <div className="flex items-center mb-1 text-xl font-medium text-gray-900 dark:text-white">
                                ...
                                <a href={contactInfo.githubLink} className="text-blue-600  dark:text-gray-300" target="_blank" rel="noopener noreferrer">
                                    GitHub
                                </a>
                            </div>
                        </div>
